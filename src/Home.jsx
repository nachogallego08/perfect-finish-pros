      ...
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-24 pb-16">
          ...
          >
            ...
            <span className="block text-neutral-400 text-4xl sm:text-5xl md:text-6xl mt-2">
              YOU CAN TRUST.
            </span>
          </h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            <div>
              ...
              >
                THE STANDARD OTHER
                <br />
                <span className="text-orange-500">CONTRACTORS</span> SET
                <br />
                ASIDE — WE KEEP.
              </h2>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              {whyUs.map((w) => (
                <div
                  key={w.title}
                  className="p-6 rounded-2xl bg-neutral-900 border border-white/5 hover:border-orange-500/20 transition-all"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 reveal-section">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {testimonials.map((t) => (
              <div
                key={t.name}
                className="p-8 rounded-2xl bg-neutral-900 border border-white/5 hover:border-orange-500/20 transition-all"
              >
